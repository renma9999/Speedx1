if string.lower(game:GetService("RbxAnalyticsService"):GetClientId()) == game:GetService("RbxAnalyticsService"):GetClientId() then
    ...
    ImageButton.Image = "http://www.roblox.com/asset/?id=10895155159"
...
local LogoHub = Instance.new("ImageLabel")
	...
	LogoHub.Image = "http://www.roblox.com/asset/?id=10895155159"..tostring(logo)
...
local NameHub2 = Instance.new("TextLabel")
   ...
   local NameMap = Instance.new("TextLabel")
	...
	NameMap.Text = "[ UPDATE ] Blox Fruits 17.3"
	...
	Logo.Image = "http://www.roblox.com/asset/?id=10895155159"..tostring(logo)
	...
	function uitab:Tab(text)
		...
		function main:Toggle(text,config,callback)
	        ...
	        ImgToggle.Image = "http://www.roblox.com/asset/?id=10895155159"..tostring(logo)
...
MODILEMAGE.Image = "http://www.roblox.com/asset/?id=10895155159"
...
local Library = Update:Window("SPEED","",Enum.KeyCode.RightControl);
Main3 = Library:Tab("MainFarm")
 Main = Library:Tab("item")
 Stats = Library:Tab("Stats")
 Combat = Library:Tab("Combat")
 Dungeon = Library:Tab("Raid")
...
Main3:Toggle("AutoFarm Level",_G.AutoFarm,function(value)
    ...
    Main3:Toggle("Bring Mob",true,function(Mag)
    _G.BringMonster = Mag
    end)
    spawn(function()
        while task.wait() do
...
Main3:Toggle("Auto Haki",true,function(value)
_G.AUTOHAKI = value
end)
spawn(function()
    while wait(.1) do
...
Main3:Toggle("Fast Attack",true,function(Fast)
    _G.FastAttack = Fast
end)
...
spawn(function()
    ...
    Main3:Toggle("Very Fast Attack",nil,function(value)
...
spawn(function()
    ...
    Main3:Toggle("Super Fast Attack",nil,function(value)
getgenv().Combat = true
loadstring(game:HttpGet("https://992198ac-079e-40b4-8767-8eb0b37f201c.id.repl.co/CRAHH.lua"))()
    end) 

    Main3:Toggle("remove attack",true,function(value)
...
spawn(function()
    ...
    Main3:Toggle("Delete Attack FIx",nil,function(d)
    _G.DeleteAttackFx = d
...
elseif _G.WhiteScreen == false then
   ...
   Main:Seperator("Mastery")
    ...
    Main:Button("Buy Geppo",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Geppo")
    end)
    
    Main:Button("Buy Buso Haki",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Buso")
    end)
    
    Main:Button("Buy Soru",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Soru")
    end)
    
    Main:Button("Buy Observation(Ken) Haki",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk","Buy")
    end)
    
    Main:Seperator("Fighting Style")
    
    Main:Button("Buy Black Leg",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBlackLeg")
    end)
    
    Main:Button("Buy Electro",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectro")
    end)
    
    Main:Button("Buy Fishman Karate",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyFishmanKarate")
    end)
    
    Main:Button("Buy Dragon Claw",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","1")
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","2")
    end)
    
    Main:Button("Buy Superhuman",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman")
    end)
    
    Main:Button("Buy Death Step",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep")
    end)
    
    Main:Button("Buy Sharkman Karate",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate",true)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate")
    end)
    
    Main:Button("Buy Electric Claw",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw")
    end)
    
    Main:Button("Buy Dragon Talon",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon")
    end)
    -----Shop----------------
    Main:Seperator("Accessory")
    
    Main:Button("Tomoe Ring",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Tomoe Ring")
    end)
    
    Main:Button("Black Cape",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Black Cape")
    end)
    
    Main:Button("Swordsman Hat",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Swordsman Hat")
    end)
    
    Main:Seperator("Sword")
    
    Main:Button("Cutlass",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Cutlass")
    end)
    
    Main:Button("Katana",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Katana")
    end)
    
    Main:Button("Iron Mace",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Iron Mace")
    end)
    
    Main:Button("Duel Katana",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Duel Katana")
    end)
    
    Main:Button("Triple Katana", function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Triple Katana")
    end)
    
    Main:Button("Pipe",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Pipe")
    end)
    
    Main:Button("Dual Headed Blade",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Dual-Headed Blade")
    end)
    
    Main:Button("Bisento",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Bisento")
    end)
    
    Main:Button("Soul Cane",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Soul Cane")
    end)
    
    Main:Button("Gun")
    
    Main:Button("Slingshot",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Slingshot")
    end)
    
    Main:Button("Musket",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Musket")
    end)
    
    Main:Button("Flintlock",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Flintlock")
    end)
    
    Main:Button("Refined Flintlock",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Refined Flintlock")
    end)
    
    Main:Button("Cannon",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Cannon")
    end)
    
    Main:Button("Kabucha",function()
    ...
    spawn(function()
        ...
        Stats:Seperator("World")
    
    Stats:Button("Teleport To Old World",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
    end)
    
    Stats:Button("Teleport To Second Sea",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
    end)
    
    Stats:Button("Teleport To Third Sea",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
    end)
    
    Stats:Button("Teleport to Seabeast",function()
    ...
    Stats:Seperator("Island")
    
    if W then
        Stats:Dropdown("Select Island",{
            "WindMill",
            "Marine",
            "Middle Town",
            "Jungle",
    ...
    Stats:Toggle("Teleport",false,function(value)
    ...
    Combat:Seperator("Fruit DV")
    
    Combat:Button("2ั32ำ62ั32ึ12ำ32ฯ52ั32ำ62า12ิ42ี8",function()
        NextplySelect = true
        wait(.1)
        NextplySelect = false
    end)
        
    Combat:Seperator("Sniper")
    ...
    _G.SelectFruit = ""
    Combat:Dropdown("Select Fruits Sniper",FruitList,function(value)
        _G.SelectFruit = value
    end)
    
    Combat:Toggle("Auto Buy Fruit Sniper",_G.AutoBuyFruitSniper,function(value)
        _G.AutoBuyFruitSniper = value
    end)
    
    Combat:Seperator("Others")
    
    Combat:Dropdown("Select Fruits Eat",FruitList,function(value)
        _G.SelectFruitEat = value
    end)
    
    Combat:Toggle("Auto Eat Fruit",_G.AutoEatFruit,function(value)
    ...
    Combat:Toggle("Auto Eat Fruit Hop",_G.AutoEatFruitHop,function(value)
    ...
    Combat:Toggle("Auto Random Fruit",_G.Random_Auto,function(value)
    ...
    Combat:Button("Random Fruit",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Cousin","Buy")
    end)
    
        Combat:Button("Open Devil Shop",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
        game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
    end)
    
    Combat:Toggle("Auto Drop Fruit",_G.DropFruit,function(value)
        _G.DropFruit = value
    end)
    ...
    Combat:Toggle("Auto Store Fruit",_G.AutoStoreFruit,function(value)
    ...
    Combat:Toggle("Grab Fruit",_G.BringFruit,function(value)
        _G.BringFruit = value
        pcall(function()
        ...
        Combat:Toggle("Bring All Fruit 75% Kick System",_G.BringFruitBF,function(value)
